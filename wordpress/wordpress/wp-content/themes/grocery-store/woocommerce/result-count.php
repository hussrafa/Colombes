...
$products_per_page = apply_filters( 'grocery_store_product_per_page', '12' );
...
<ul class="result-count">
    <li class="view-title"><?php echo esc_html__('View:','grocery-store'); ?>
	</li>
    ...
    <li><a class="view-all<?php if ( $num_prod == 'all' ) echo ' active'; ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php echo esc_html__('ALL:','grocery-store'); ?></a></li>
</ul>
