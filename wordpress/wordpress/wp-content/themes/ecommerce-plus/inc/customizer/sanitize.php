...
if ( ! function_exists( 'ecommerce_plus_sanitize_select' ) ) :
	/**
	 ...
	 */
	function ecommerce_plus_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'ecommerce_plus_sanitize_image' ) ) :
	/**
	 ...
	 */
	function ecommerce_plus_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'ecommerce_plus_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function ecommerce_plus_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'ecommerce_plus_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since 1.0.0
	*/
	function ecommerce_plus_sanitize_page( $input ) {
...
if ( ! function_exists( 'ecommerce_plus_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since 1.0.0
...
if( ! function_exists( 'ecommerce_plus_sanitize_single_category' ) ) :
	/**
	 ...
	 */
	function ecommerce_plus_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'ecommerce_plus_sanitize_category_list' ) ) :
	/**
	 ...
	 */
	function ecommerce_plus_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'ecommerce_plus_santize_allowed_html' ) ) :
	/**
	 ...
	 */
	function ecommerce_plus_santize_allowed_html( $input ) {
 ...
 * @return boolean    
 */
function ecommerce_plus_sanitize_switch_control( $input ) {
...
* @since 1.0.0
*/
function ecommerce_plus_sanitize_links( $input ) {
...
if ( ! function_exists( 'ecommerce_plus_sanitize_sortable' ) ) :
	/**
	...
	* @since 1.0.0
	*/
	function ecommerce_plus_sanitize_sortable( $input ) {
