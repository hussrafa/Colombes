...
if ( isset( $_GET['ecommerce_plus_notice_dismissed'] ) ){
	...
	update_option('ecommerce_plus_help_notice', -1);
}

$ecommerce_plus_help_notice = get_option('ecommerce_plus_help_notice', 1);

$ecommerce_plus_refreshed = isset($_SERVER['HTTP_CACHE_CONTROL'])
								&& ($_SERVER['HTTP_CACHE_CONTROL'] === 'max-age=0'
								||  $_SERVER['HTTP_CACHE_CONTROL'] == 'no-cache');

if (($ecommerce_plus_help_notice > 0 || $ecommerce_plus_help_notice == '') && !$ecommerce_plus_refreshed ){
